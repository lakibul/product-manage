                                                ...
                                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                    <tr>
                                                        <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;" align="center">
                                                            ...
                                                            <img align="center" border="0" src="{{asset('/')}}email/images/image-4.png" alt="image" title="image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 485px;" width="485"/>
                                        ...
                                        <tr>
                                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Montserrat',sans-serif;" align="left">
                                                ...
                                                <h1 class="v-text-align v-font-size" style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: 'Montserrat',sans-serif; font-size: 25px;">
                                                    <strong>Product Added to Inventory</strong>
                                                </h1>
                                        ...
                                        <tr>
                                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:0px 30px;font-family:'Montserrat',sans-serif;" align="left">
                                                ...
                                                <div class="v-text-align" style="line-height: 160%; text-align: justify; word-wrap: break-word;">
                                                    <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 16px; line-height: 25.6px;"><strong>Hey Merchant !</strong></span></p>
                                                    <p style="font-size: 14px; line-height: 160%;"> </p>
                                                    <p style="font-size: 14px; line-height: 160%;">{{$details['body']}}</p>
                                                    <p style="font-size: 14px; line-height: 160%;"> </p>
                                                    <p style="font-size: 14px; line-height: 160%;">Your Product details:</p>

                                                    @if(isset($product))
                                                    <p style="font-size: 14px; line-height: 160%;"><strong>Name: {{$product['name']}}</strong></p>
                                                    <p style="font-size: 14px; line-height: 160%;"><strong>
                                                            SKU Number: {{$product['sku']}}<br />
                                                            Price: {{$product['price']}}<br />
                                                            Short Description: {{$product['short_description']}}<br />
                                                            Long Description: {{$product['long_description']}}<br /><br />
                                                        </strong></p>

                                                    @elseif(isset($inventory_product))
                                                        <p style="font-size: 14px; line-height: 160%;"><strong>Name: {{$inventory_product->products->name}}</strong></p>
                                                        <p style="font-size: 14px; line-height: 160%;"><strong>
                                                                SKU Number: {{$inventory_product->products->sku}}<br />
                                                                Price: {{$inventory_product->products['price']}}<br />
                                                                Short Description: {{$inventory_product->products['short_description']}}<br />
                                                                Long Description: {{$inventory_product->products['long_description']}}<br /><br />
                                                            </strong></p>

                                                    @elseif(isset($disableProduct))
                                                        <p style="font-size: 14px; line-height: 160%;"><strong>Name: {{$disableProduct->product->name}}</strong></p>
                                                        <p style="font-size: 14px; line-height: 160%;"><strong>
                                                                SKU Number: {{$disableProduct->product->sku}}<br />
                                                                Price: {{$disableProduct->product['price']}}<br />
                                                                Short Description: {{$disableProduct->product['short_description']}}<br />
                                                                Long Description: {{$disableProduct->product['long_description']}}<br /><br />
                                                            </strong></p>
                                                    @endif
                                        ...
                                        <tr>
                                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Montserrat',sans-serif;" align="left">
                                                ...
                                                <h1 class="v-text-align v-font-size" style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: 'Montserrat',sans-serif; font-size: 19px;">
                                                    <strong>ParallaxLogic InfoTech</strong>
                                                </h1>
                                                        ...
                                                        <table align="left" border="0" cellspacing="0" cellpadding="0" width="32" height="32" style="width: 32px !important;height: 32px !important;display: inline-block;border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;margin-right: 5px">
                                                            <tbody><tr style="vertical-align: top"><td align="left" valign="middle" style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                                    <a href="https://twitter.com/" title="Twitter" target="_blank">
                                                                        <img src="{{asset('/')}}email/images/image-2.png" alt="Twitter" title="Twitter" width="32" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                                                                    </a>
                                                                </td></tr>
                                                            </tbody></table>
                                                        <!--[if (mso)|(IE)]></td><![endif]-->
